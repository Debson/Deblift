...
public class TemplateExerciseRecycleAdapter extends RecyclerView.Adapter {

    private RecyclerView recyclerView;
    private RecyclerView.LayoutManager layoutManager;
    private ArrayList<TemplateSetRecycleAdapter> adapterList = new ArrayList<>();
    ...
    public TemplateExerciseRecycleAdapter() {
        for(int i = 0; i < itemCount; i++)
            adapterList.add(new TemplateSetRecycleAdapter());
    }
